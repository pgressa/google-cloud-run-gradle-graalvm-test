...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://google-cloud-run-gradle-graalvm-test-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://google-cloud-run-gradle-graalvm-test-__________run.app
```

Call the api endpoint:
```
curl https://google-cloud-run-gradle-graalvm-test-__________run.app/googleCloudRunGradleGraalvmTest
```
